    ...
    <section className={s.container}>
      ...
      <div className={s.about}>
        ...
        <div className={s.blockText}>
          ...
          <p className={s.text}>
            107 реактивна артилерійська Кременчуцька бригада — елітний ракетний підрозділ Сил оборони України, що має високий рівень бойової підготовки та сучасне озброєння. Особовий склад проходить інтенсивне навчання, що дозволяє ефективно виконувати бойові завдання в будь-яких умовах.
